...
# Scenario 1: Wafers 651-720 - Oxidation thermal drift and domino effect
...
# Scenario 2: Wafers 800-850 - Particle contamination (subset causing breakdown)
...
# Scenario 3: Single Outliers (Hidden critical defects)
...
# 3. DATAFRAME CREATION & REPORT EXPORT
